                ...
                <div class="text-center" style="background: #f9f3f9; padding: 15px; border-radius: 15px;">
                    ...
                    <asp:Label ID="lblValidado" runat="server" Text="" Visible="False"></asp:Label>
                        ...
                        <div class="form-group input-field">
                            <asp:TextBox ID="Cedula" runat="server" TextMode="SingleLine" ClientIDMode="Static" ></asp:TextBox>
                        ...
                        <div class="form-group">
                            <asp:Button ID="btnRecuperar" runat="server" Text="Recuperar Contraseña" CssClass="btn btn-lg btn-purple btn-block"  OnClick="btnRecuperar_Click" />
                        </div>
                       </div>
