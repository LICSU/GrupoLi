<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PagosAlumno.aspx.cs" Inherits="sistema_PagosAlumno" %>
        ...
        <div class="row">
            <asp:UpdatePanel ID="upCrudGrid" runat="server">
                <ContentTemplate>
                    ...
                    DataKeyNames="PlanPagoID" CssClass="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" PageSize="20"
